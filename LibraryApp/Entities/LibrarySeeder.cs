    ...
    public class LibrarySeeder
    {
        ...
        public void SeedDbValues()
        {
            ...
            _context.Loans.AddRange(
                new Loan { UserID = users[0].UserID, BookCopyID = bookCopies[0].Id, LoanDate = DateTime.Now.AddDays(-7), ReturnDate = DateTime.Now.AddDays(7) },
                new Loan { UserID = users[1].UserID, BookCopyID = bookCopies[1].Id, LoanDate = DateTime.Now.AddDays(-6), ReturnDate = DateTime.Now.AddDays(8) },
                new Loan { UserID = users[2].UserID, BookCopyID = bookCopies[2].Id, LoanDate = DateTime.Now.AddDays(-5), ReturnDate = DateTime.Now.AddDays(9) }
            );
